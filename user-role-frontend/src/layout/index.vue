    ...
    <div style="width: 200px; background-color: #222f3e">
      <el-aside :width="isCollapse ? '60px' : '200px'">
        <el-col :gutter="20">
          <el-row :span="4">
            <div class="logo">
              <div class="sys-name" v-show="!isCollapse">用户角色管理系统</div>
            </div>
          </el-row>
          <el-row :span="20">
            <el-menu
      ...
      <el-header>
        ...
        >
          <el-submenu index="1" class="user-icon">
            ...
            <el-menu-item index="1-1" @click="logout"><i class="el-icon-s-promotion"></i>退出</el-menu-item>
          </el-submenu>
        </el-menu>
      </el-header>
      <el-main>
...
export default {
  ...
  created() {
    selectList(this.menuListForm).then((res) => {
      ...
      return ['用户管理', '角色管理', '权限管理'].includes(item.name);
    });
...
.el-main {
  background-image: url('~@/assets/ground.jpg'); /* 添加背景图片 */
  background-size: 108%; /* 背景图片全覆盖 */
